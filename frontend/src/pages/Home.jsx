...
const Home = () => {
  ...
  const GuestHero = () => (
    <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
      ...
      {/* Тонкие угловые акценты - нотка изящества */}
      <div className="absolute top-8 left-8 w-16 h-16 border-t border-l border-sky-500/20"></div>
      <div className="absolute top-8 right-8 w-16 h-16 border-t border-r border-sky-500/20"></div>
      <div className="absolute bottom-8 left-8 w-16 h-16 border-b border-l border-blue-500/20"></div>
      <div className="absolute bottom-8 right-8 w-16 h-16 border-b border-r border-blue-500/20"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl text-white mb-6 leading-tight" style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}>
            ...
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed max-w-xl" style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}>
              {t('hero.subtitle')}
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                to="/register"
                className="group px-8 py-4 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-400 hover:to-blue-500 text-white font-medium rounded-lg shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 transition-all duration-300 flex items-center gap-2"
              >
              ...
              <a
                href="#about"
                className="group px-8 py-4 border border-slate-600/80 text-slate-300 hover:border-sky-500/50 hover:text-white font-medium rounded-lg transition-all duration-300 flex items-center gap-2"
              >
          ...
          <div className="hidden lg:block relative">
            <div className="relative">
              {/* Фоновые круги с элегантными штрихами */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-80 h-80 border border-slate-700/60 rounded-full"></div>
                <div className="absolute w-64 h-64 border border-slate-700/40 rounded-full"></div>
                <div className="absolute w-48 h-48 border border-sky-500/20 rounded-full"></div>
                {/* Декоративные точки на кругах */}
                <div className="absolute w-2 h-2 bg-sky-400/60 rounded-full" style={{ top: '10%', right: '30%' }}></div>
                <div className="absolute w-1.5 h-1.5 bg-blue-400/40 rounded-full" style={{ bottom: '20%', left: '25%' }}></div>
              </div>

              {/* Карточки с утончёнными деталями */}
              <div className="relative z-10 space-y-4 p-8">
                <div className="group bg-slate-800/70 backdrop-blur-sm border border-slate-700/80 rounded-lg p-4 ml-auto w-72 transform hover:scale-[1.02] hover:border-sky-500/30 transition-all duration-300">
                ...
                <div className="group bg-slate-800/70 backdrop-blur-sm border border-slate-700/80 rounded-lg p-4 w-72 transform hover:scale-[1.02] hover:border-blue-500/30 transition-all duration-300">
                  <div className="flex items-center gap-3">
  ...
  return (
    <div>
      ...
      <section id="about" className="relative overflow-hidden py-16 md:py-20">
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-sky-500/[0.03] rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-blue-500/[0.03] rounded-full blur-3xl"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-3 mb-4">
              ...
              <span className="text-amber-700/70 text-xs tracking-[0.25em] uppercase" style={{ fontFamily: 'Georgia, serif' }}>
                {t('about.label', 'О нас')}
              </span>
              <div className="w-8 h-px bg-gradient-to-l from-transparent to-amber-600/40"></div>
            </div>
            <p className="text-lg text-stone-500 max-w-2xl mx-auto" style={{ fontFamily: 'Georgia, serif' }}>
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-4">
              <div className="relative group/logo max-w-[280px] mx-auto">
                {/* Рамка */}
                <div className="absolute -inset-3 border border-stone-200/60 group-hover/logo:border-stone-300/80 transition-colors duration-500"></div>

                {/* Угловые акценты */}
                <div className="absolute -top-3 -left-3 w-6 h-6 border-t-2 border-l-2 border-amber-600/50"></div>
                <div className="absolute -top-3 -right-3 w-6 h-6 border-t-2 border-r-2 border-amber-600/50"></div>
                <div className="absolute -bottom-3 -left-3 w-6 h-6 border-b-2 border-l-2 border-amber-600/50"></div>
                <div className="absolute -bottom-3 -right-3 w-6 h-6 border-b-2 border-r-2 border-amber-600/50"></div>

                {/* Логотип */}
                <div className="relative bg-gradient-to-br from-white to-stone-50 p-6 shadow-sm group-hover/logo:shadow-md transition-shadow duration-500">
                  <img
              ...
              <div className="flex justify-center gap-8 mt-8">
                {[
                  { number: '14', suffix: '+', label: 'Регионов' },
                  { number: '100', suffix: '+', label: 'Врачей' },
                  { number: '10', suffix: '+', label: 'Лет' }
                ].map((stat, i) => (
                  <div key={i} className="text-center">
                    <div className="flex items-baseline justify-center">
                      ...
                      <span className="text-lg text-amber-600 ml-0.5">{stat.suffix}</span>
                    </div>
            ...
            <div className="lg:col-span-8">
              {/* Текст */}
              <div className="space-y-4 mb-8 text-stone-600 leading-relaxed" style={{ fontFamily: 'Georgia, serif' }}>
                <p>
                  <span className="text-4xl float-left mr-2 mt-1 text-amber-700/80 leading-none" style={{ fontFamily: 'Georgia, serif' }}>А</span>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
                {[
                  ...
                  <div key={i} className="group flex flex-col items-center p-3 rounded-xl border border-transparent hover:border-stone-200 hover:bg-white/80 hover:shadow-sm transition-all duration-300">
                    <div className="w-10 h-10 rounded-full border border-stone-200 flex items-center justify-center text-stone-500 group-hover:border-sky-400/50 group-hover:text-sky-600 group-hover:bg-sky-50/50 transition-all duration-300 mb-2">
                      {item.icon}
                    </div>
              ...
              <div className="flex flex-wrap gap-3">
                <Link
                  to="/about"
                  className="group inline-flex items-center gap-2 px-5 py-2.5 bg-stone-800 text-white text-sm rounded-lg hover:bg-stone-700 hover:shadow-lg hover:shadow-stone-800/20 transition-all duration-300"
                >
                  <span>Подробнее</span>
                  <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {charter?.file_url && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 border border-stone-300 text-stone-700 text-sm rounded-lg hover:border-sky-300 hover:text-sky-700 hover:bg-sky-50/30 transition-all duration-300"
                  >
      ...
      <section className="relative py-14 md:py-16 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-sky-500/[0.03] rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-blue-500/[0.03] rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-amber-500/[0.02] rounded-full blur-3xl"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-3 mb-3">
              <div className="w-10 h-px bg-gradient-to-r from-transparent to-amber-700/40"></div>
              ...
              <div className="w-10 h-px bg-gradient-to-l from-transparent to-amber-700/40"></div>
            </div>
            <h2 className="text-3xl md:text-4xl text-stone-800 mb-3" style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}>
              {t('activities.title', 'Наша деятельность')}
            </h2>
            <div className="flex items-center justify-center gap-3 mb-3">
              <div className="w-12 h-px bg-gradient-to-r from-transparent via-stone-300 to-sky-400/30"></div>
              <div className="w-1.5 h-1.5 bg-gradient-to-br from-amber-600/50 to-sky-500/40 rotate-45"></div>
              <div className="w-12 h-px bg-gradient-to-l from-transparent via-stone-300 to-sky-400/30"></div>
            </div>
            <p className="text-stone-500 max-w-2xl mx-auto text-sm" style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4">
            ...
            <div className="lg:col-span-5 lg:row-span-2 group">
              <div className="relative h-full bg-gradient-to-br from-slate-800 via-slate-800 to-slate-900 rounded-sm p-6 overflow-hidden">
                {/* Декоративные элементы */}
            ...
            <div className="lg:col-span-4 group">
              <div className="relative h-full bg-white border border-stone-200 rounded-sm p-6 hover:border-blue-300/50 hover:shadow-lg hover:shadow-blue-100/50 transition-all duration-500 overflow-hidden">
            ...
            <div className="lg:col-span-3 group">
              <div className="relative h-full bg-gradient-to-br from-sky-50 to-blue-50 border border-sky-200/50 rounded-sm p-6 hover:shadow-lg hover:shadow-sky-100/50 transition-all duration-500 overflow-hidden">
            ...
            <div className="lg:col-span-3 group">
              <div className="relative h-full bg-white border border-stone-200 rounded-sm p-6 hover:border-stone-300 hover:shadow-lg hover:shadow-stone-100/50 transition-all duration-500 overflow-hidden">
            ...
            <div className="lg:col-span-4 group">
              <div className="relative h-full bg-gradient-to-br from-amber-50/80 to-orange-50/50 border border-amber-200/50 rounded-sm p-6 hover:shadow-lg hover:shadow-amber-100/50 transition-all duration-500 overflow-hidden">
                <div className="absolute -top-px -left-px w-4 h-4 border-t border-l border-amber-400/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="absolute -bottom-px -right-px w-4 h-4 border-b border-r border-amber-400/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            ...
            <div className="lg:col-span-5 group">
              <div className="relative h-full bg-white border border-stone-200 rounded-sm p-6 hover:border-sky-300/50 hover:shadow-lg hover:shadow-sky-100/50 transition-all duration-500 overflow-hidden">
                <div className="absolute -top-px -left-px w-4 h-4 border-t border-l border-sky-400/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="absolute -bottom-px -right-px w-4 h-4 border-b border-r border-sky-400/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
      ...
      {boardMembers.length > 0 && (
        <section className="py-16 md:py-20 bg-stone-50 relative overflow-hidden">
          ...
          <div className="absolute top-1/4 left-0 w-[600px] h-[600px] bg-blue-500/[0.02] rounded-full blur-3xl"></div>
          <div className="absolute bottom-1/4 right-0 w-[500px] h-[500px] bg-sky-500/[0.02] rounded-full blur-3xl"></div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-3 mb-4">
                <div className="w-10 h-px bg-gradient-to-r from-transparent to-amber-700/40"></div>
                <span className="text-amber-800/70 text-xs font-medium tracking-[0.25em] uppercase">
                  {t('about.board.label', 'Руководство')}
                </span>
                <div className="w-10 h-px bg-gradient-to-l from-transparent to-amber-700/40"></div>
              </div>
              <h2 className="text-3xl md:text-4xl text-stone-800 mb-4 tracking-tight" style={{ fontFamily: 'Georgia, "Times New Roman", serif', fontWeight: 400 }}>
                {t('about.board.title', 'Правление ассоциации')}
              </h2>
              <div className="flex items-center justify-center gap-3">
                <div className="w-16 h-px bg-gradient-to-r from-transparent via-stone-300 to-sky-400/20"></div>
                <div className="w-1.5 h-1.5 bg-gradient-to-br from-amber-700/50 to-blue-600/30 rotate-45"></div>
                <div className="w-16 h-px bg-gradient-to-l from-transparent via-stone-300 to-sky-400/20"></div>
              </div>
              <p className="text-stone-500 text-sm mt-4 max-w-xl mx-auto leading-relaxed" style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}>
              ...
              {boardMembers.map((member, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`absolute -top-2 ${isEven ? 'left-0' : 'right-0'} text-[80px] md:text-[100px] font-light text-stone-200/50 select-none -z-10 leading-none`}
                      style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}
                    >
                      {String(index + 1).padStart(2, '0')}
                    </div>

                    <div className={`flex flex-col ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'} gap-10 md:gap-12 items-start`}>
                      {/* Портрет - классическая рамка с современными акцентами */}
                      <div className="w-full md:w-5/12 flex-shrink-0">
                        <div className="relative group/photo">
                          {/* Внешняя рамка - тонкая, золотистая */}
                          <div className="absolute -inset-3 border border-amber-700/20 rounded-sm group-hover/photo:border-amber-600/30 transition-colors duration-500"></div>
                          <div className="absolute -inset-1.5 border border-stone-300/50 rounded-sm"></div>
                          ...
                          {getField(member, 'position') && (
                            <div className="absolute -bottom-6 left-0 right-0 text-center">
                              <span className="inline-block px-4 py-1.5 bg-stone-800 text-stone-100 text-xs tracking-wider uppercase rounded-sm shadow-md group-hover/photo:shadow-lg group-hover/photo:bg-stone-700 transition-all duration-300" style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}>
                                {getField(member, 'position')}
                              </span>
                            </div>
                          )}
                      ...
                      {/* Информация */}
                      <div className="w-full md:w-7/12 pt-6 md:pt-0">
                        {/* Имя - элегантный стиль */}
                        <h3 className="text-2xl md:text-3xl text-stone-800 mb-2 leading-snug tracking-tight" style={{ fontFamily: 'Georgia, "Times New Roman", serif', fontWeight: 400 }}>
      ...
      {partners.length > 0 && (
        <section className="relative py-14 md:py-18 overflow-hidden">
          ...
          {/* Декоративные элементы */}
          <div className="absolute inset-0">
            <div className="absolute top-0 left-1/4 w-[400px] h-[400px] bg-sky-500/[0.05] rounded-full blur-3xl"></div>
            <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] bg-blue-500/[0.05] rounded-full blur-3xl"></div>
            {/* Элегантный паттерн */}
            <div className="absolute inset-0 opacity-[0.02]" style={{
              backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 0L60 30L30 60L0 30Z' fill='none' stroke='%23fff' stroke-width='0.5'/%3E%3C/svg%3E")`,
              backgroundSize: '60px 60px'
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-3 mb-4">
                <div className="w-10 h-px bg-gradient-to-r from-transparent to-sky-400/50"></div>
                <div className="w-1.5 h-1.5 rotate-45 border border-sky-400/50"></div>
                <div className="w-10 h-px bg-gradient-to-l from-transparent to-sky-400/50"></div>
              </div>

              {/* Иконка глобуса */}
              <div className="w-14 h-14 mx-auto mb-4 rounded-lg bg-slate-800/80 border border-slate-700/80 flex items-center justify-center">
              ...
              <p className="text-slate-400 max-w-2xl mx-auto text-sm leading-relaxed" style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}>
            ...
            <div className="grid md:grid-cols-3 gap-5 lg:gap-6 max-w-5xl mx-auto">
              {partners.map((partner) => (
                ...
                >
                  {/* Карточка */}
                  <div className="relative bg-slate-800/50 backdrop-blur-sm rounded-sm p-5 border border-slate-700/60 hover:border-sky-500/30 transition-all duration-500 text-center">
                    {/* Угловые акценты */}
                    <div className="absolute -top-px -left-px w-5 h-5 border-t border-l border-sky-500/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div className="absolute -bottom-px -right-px w-5 h-5 border-b border-r border-blue-500/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    ...
                    <div className="relative w-20 h-20 mx-auto mb-4">
                      ...
                      <div className="w-full h-full bg-white/95 flex items-center justify-center p-2.5 group-hover:shadow-lg group-hover:shadow-sky-500/10 transition-shadow duration-500">
                        {partner.logo_url ? (
                          <img src={partner.logo_url} alt={partner.short_name} className="w-full h-full object-contain" />
                        ) : (
                          <span className="text-xl font-bold text-slate-700" style={{ fontFamily: 'Georgia, serif' }}>{partner.short_name || '?'}</span>
                        )}
                      </div>
                    </div>

                    {/* Аббревиатура */}
                    <h3 className="text-lg text-white mb-1.5 group-hover:text-sky-300 transition-colors duration-300" style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}>
                      {partner.short_name || getField(partner, 'name')}
                    </h3>

                    {/* Разделитель */}
                    <div className="w-6 h-px bg-slate-600 mx-auto mb-2 group-hover:w-10 group-hover:bg-sky-500/50 transition-all duration-300"></div>
